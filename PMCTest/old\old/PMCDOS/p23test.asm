;                             P23TEST.ASM                    © Agner Fog 1999
;
comment %
This is a general program for testing how many clock cycles a piece of
code takes on a Pentium Pro, Pentium II, or Pentium III microprocessor.
...
© 1999 GNU General Public License www.gnu.org/copyleft/gpl.html
%
.386

;###################   CHOOSE EVENT COUNTERS   ############################
; set events to count on performance monitor counters:
EVENT0 = 0C0H  ; instructions retired
EVENT1 = 0C2H  ; uops retired
...
; ------------------   SET UP EVENT COUNTERS   --------------------------
        MOV     ECX, 186H
        MOV     EAX, EVENT0 OR (1 SHL 22) or (1 shl 17) 
        WRMSR                   ; performance monitor counter 0
        MOV     ECX, 187H
        MOV     EAX, EVENT1 OR (1 SHL 22) or (1 shl 17)
...
;
        inc     [D0]            ; this is just an example
